...
| CAN byte-level message specs (0x0A0–0x0B0, 0x0C0–0x0C2) | [Appendix C.4 Broadcast Message Byte Definitions](PM100_Reference_Guide.md#c4-broadcast-message-byte-definitions) |
| Command message 0x0C0 torque/speed/enable | [Appendix C.5 Command Message](PM100_Reference_Guide.md#c5-command-message--0x0c0-vehicle--pm100) |
| Parameter read/write messages 0x0C1 / 0x0C2 | [Appendix C.6 Parameter Messages](PM100_Reference_Guide.md#c6-parameter-messages--0x0c1--0x0c2) |
| EEPROM parameter address table | [Appendix C.8 Key EEPROM Parameters](PM100_Reference_Guide.md#c8-key-eeprom-parameters-address-100499--write-only-when-motor-disabled) |
