...
> **Detailed CAN specifications** — frame structure, data format conventions, all broadcast
> message byte definitions, command message 0x0C0, parameter messages 0x0C1/0x0C2, EEPROM
> parameter addresses, timeout behaviour, and BMS integration are documented in
> [Appendix C — CAN Protocol Detail](#appendix-c--can-protocol-detail).
...
| [3] | PM100DX Inverter Drawing | 180-100-002.00 Rev 2.3 / .01 | Swindon Silicon Systems / SWIND EV | [.00 (3-sheet, PNG)](references/Ref3_PM100DX_Inverter_Drawing_180-100-002.00.png) · [.01 (sheet 1, PDF)](references/Ref3_PM100DX_Inverter_Drawing_180-100-002.01.pdf) | Factory low-voltage wiring schematic. .00 is a PNG scan of the 3-sheet set held by BlueBoy; .01 is the publicly available single-sheet PDF revision from Swindon Powertrain. |
...
## Appendix C — CAN Protocol Detail

This appendix contains the full byte-level CAN message specifications for the PM100.
All content is sourced from Cascadia Motion CAN Protocol Rev 5.9 (25 Feb 2022) \[Ref 1\].
See [§14 References](#14-references) for firmware version compatibility notes.

### C.1 CAN Frame Structure
...
### C.4 Broadcast Message Byte Definitions
...
### C.5 Command Message — 0x0C0 (Vehicle → PM100)
...
### C.6 Parameter Messages — 0x0C1 / 0x0C2
...
### C.7 Key Command Parameters (Address 0–99, General — read/write via 0x0C1)
...
### C.8 Key EEPROM Parameters (Address 100–499 — write only when motor disabled)
...
### C.10 Rolling Counter (Gen 5 / CM firmware only)
